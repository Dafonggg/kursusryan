...
<html lang="en">
    <head>
        ...
        <meta name="description" content="@yield('description', 'Instructor Dashboard | Kursus Ryan Komputer')">
        <meta name="csrf-token" content="{{ csrf_token() }}">

        <title>@yield('title', 'Instructor Dashboard | Kursus Ryan Komputer')</title>

        <!--begin::Instructor Dashboard Styles-->
        @include('instructor.partials.style')
        @stack('styles')
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default @yield('body-class', '')">
        ...
        <!--begin::Instructor Dashboard Scripts-->
        @include('instructor.partials.scripts')
        @stack('scripts')
        <!--end::Instructor Dashboard Scripts-->
    </body>
</html>
